        ...
        <nav className="absolute top-0 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8 py-6">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="#experiences" className="text-white/90 hover:text-white transition-colors">
                Experiences
              </Link>
              <Link href="#about" className="text-white/90 hover:text-white transition-colors">
                About
              </Link>
              <Link href="#business" className="text-white/90 hover:text-white transition-colors">
                Business
              </Link>
