...
\
        ...
        if (!bookingsError && bookings) \{
          ...
          const currentMonthBookings = bookings.filter(
            (b) => b.created_at >= startOfMonth && b.created_at <= today
          );
          bookingsMade = currentMonthBookings.length;
          paymentsReceived = currentMonthBookings.filter(
            (b) => b.payment_status === "paid" || b.payment_status === "completed"
          ).reduce((sum, b) => sum + (Number(b.total_price) || 0), 0);
          bookingsFulfilled = currentMonthBookings.filter(
          ...
          const allConfirmedBookings = bookings.filter((b) => b.booking_status === "confirmed")\
          totalRevenue = allConfirmedBookings.reduce((sum, booking) => \
      ...
      notifications = [
        \{ id: "1", message: "New booking confirmed for 'Sunset Kayak Tour' on 2024-07-15.", type: "success", timestamp: "2 hours ago" \},
        \{ id: "2", message: "Your 'Diving Expedition' experience is low on availability for next week.", type: "warning", timestamp: "1 day ago" \},
        \{ id: "3", message: "Payment received for booking #12345.", type: "info", timestamp: "3 days ago" \},
        \{ id: "4", message: "Review your business settings for optimal performance.", type: "info", timestamp: "5 days ago" \},
      ];
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-bold text-yellow-600">€\{dashboardData.earnings.pending.toLocaleString()\}</span>
                </div>
